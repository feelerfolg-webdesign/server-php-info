...
* GitHub Plugin URI: https://github.com/feelerfolg-webdesign/server-php-info
* Text Domain: server-php-info
**/

add_action('wp_dashboard_setup', 'server_php_info_add_dashboard_widget');

function server_php_info_add_dashboard_widget() {
    if (current_user_can('manage_options')) {
        wp_add_dashboard_widget(
            'server_php_info_dashboard_widget',
            'Server PHP Info',
            'server_php_info_display'
        );
    }
}

function server_php_info_display() {
